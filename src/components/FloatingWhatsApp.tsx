  ...
  return (
    <>
      ...
      <a
        ...
        className="hidden md:flex fixed bottom-6 right-6 z-40 items-center gap-2.5 bg-emerald-500 hover:bg-emerald-600 text-white p-3.5 px-5 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 group border-2 border-white"
      ...
      <div className="md:hidden fixed bottom-0 inset-x-0 z-40 bg-white/95 backdrop-blur-md border-t border-gray-200 px-3 py-2 grid grid-cols-3 gap-2 shadow-2xl">
        <a 
